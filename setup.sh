...
mkdir datasets
cd datasets
gdown --fuzzy "https://drive.google.com/file/d/1np57yAy4rxXTcoC217C115b7qI5At76D/view?usp=sharing"
tar -xvf "VOS.tar"
rm "VOS.tar"
mkdir endovis2017
cd endovis2017
...
rm "eval_endovis2017_surgical.tar"
cd ..
mkdir endovis2018
cd endovis2018
...
rm "eval_endovis18_surgical.tar"
cd ../..
